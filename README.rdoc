  ...
  <table id="posts">
    ...
    <tbody>
      <tr class="post odd" id="post_1">
        ...
        <td class="body"Lorem ipsum dolor sit amet consequat. Duis aute irure dolor.</td>
        <td class="author">Jim Beam</td>
      </tr>
      <tr class="post even" id="post_2">
        <td class="title"Second Post</td>
        <td class="body">This is the second post</td>
        <td class="author">Jack Daniels</td>
      </tr>
      <tr class="post odd" id="post_3">
        <td class="title"Something else</td>
        <td class="body">Blah!</td>
        <td class="author"></td>
      </tr>
    </tbody>
  </table>
  ...
  <table id="posts">
    ...
    <tbody>
      <tr id="post_1" class="post odd">
        <td class="author">Jim Beam</td>
        <td class="title">Something</td>
        <td class="created_at">2009-11-15 02:42:48 UTC</td>
      </tr>
      <tr id="post_2" class="post even">
        <td class="author">Jack Daniels</td>
        <td class="title">Second Post</td>
        <td class="created_at">2009-11-16 00:11:00 UTC</td>
      </tr>
      <tr id="post_3" class="post odd">
        <td class="author"></td>
        <td class="title">Something else</td>
        <td class="created_at">2009-11-16 00:11:30 UTC</td>
      </tr>
    </tbody>
  </table>
...
will product html like:
  ...
  <table id="posts">
    ...
    <tbody>
      <tr class="post odd" id="post_1">
        <td class="titlestring title">Something</td>
        <td class="content">Lorem ipsum dolor sit amet,...</td>
        <td class="author">
      ...
      <tr class="post even" id="post_2">
        <td class="titlestring title">Second Post</td>
        <td class="content">This is the second post</td>
        <td class="author">
      ...
      <tr class="post odd" id="post_3">
        <td class="titlestring title">Something else</td>
        <td class="content">Blah!</td>
        <td class="author"></td>
        <td class="actions show_link">
